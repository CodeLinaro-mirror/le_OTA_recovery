...
* argv[1] false(default) - old binary update as a block / true - old binary update as a file
* argv[2] old binary file name. Will be used as partition name if argv[1] is false
